...
export default function Globe() {
        ...
        const updateCanvasSize = () => {
            ...
            const globe = createGlobe(canvas, {
                ...
                arcs: [
                    ...
                    // Europe to India
                    { from: [52.37, 4.89], to: [28.61, 77.23] },
                    { from: [47.37, 8.55], to: [19.08, 72.88] },
    ...
    return (
        <canvas
            ref={canvasRef}
            style={{ position: 'absolute', top: 0, left: 0, width: '70%', height: '100%', zIndex: 0, transform: 'translateX(20%) translateY(50%)' }}
        ></canvas>
    )
}
